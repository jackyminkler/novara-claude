        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('NOTIFICATIONS_PAGE_arrowLeft_ICN_ON_TAP');
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('NOTIFICATIONS_moreVertical_ICN_ON_TAP');
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Event Rescheduled: New Date Confirmed',
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            font: GoogleFonts.rubik(
