          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 0.0),
                child: Text(
                  'We’re in our public beta, releasing fresh improvements every week. Expect easier discovery and planning, guided by your feedback. Soon, we\'ll have more innovative matching, richer activity types, and even simpler planning flows. If something feels clunky today, chances are we’re already refining it for tomorrow. We\'re always happy to hear feedback so we can build what\'s most important to you.',
                  textAlign: TextAlign.start,
                  style: FlutterFlowTheme.of(context).titleSmall.override(
                        font: GoogleFonts.rubik(
                          fontWeight: FlutterFlowTheme.of(context)
