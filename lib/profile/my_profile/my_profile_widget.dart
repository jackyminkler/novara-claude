              ...
              actions: [
                Row(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(6.0, 6.0, 16.0, 6.0),
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent('MY_PROFILE_PAGE_edit02_ICN_ON_TAP');
                      ...
                      children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MY_PROFILE_PAGE_Activities_ON_TAP');
                                              logFirebaseEvent(
                                                  'Activities_navigate_to');

                                              context.pushNamed(
                                                MyActivitiesWidget.routeName,
                                                queryParameters: {
                                                  'selectedUserRef':
                                                      serializeParam(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'View all attending and hosting',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                          ...
                                          Builder(
                                            builder: (context) => InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MY_PROFILE_PAGE_ShareProfile_ON_TAP');
                                                logFirebaseEvent(
                                                    'ShareProfile_alert_dialog');
                                                await showDialog(
                                                  context: context,
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Share your events list with friends',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Share Novara with your friends',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MY_PROFILE_PAGE_Feedback_ON_TAP');
                                              logFirebaseEvent(
                                                  'Feedback_launch_u_r_l');
                                              unawaited(
                                                () async {
                                                  await launchURL(
                                                      'https://novara.featurebase.app/');
                                                }(),
                                              );
                                            },
                                            child: Row(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Your insights will help us grow',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MY_PROFILE_PAGE_HelpCenter_ON_TAP');
                                              logFirebaseEvent(
                                                  'HelpCenter_navigate_to');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'MY_PROFILE_PAGE_Text_8513yntm_ON_TAP');
                                  ...
                                  await showDialog<bool>(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'This action can not be undone. You will lose all of your data and past activities.'),
                                            actions: [
                                              TextButton(
