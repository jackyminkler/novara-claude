...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.textFieldStravaTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.strava, ''));
    _model.textFieldStravaFocusNode ??= FocusNode();
        ...
        body: Align(
          ...
          child: ListView(
            ...
            children: [
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FlutterFlowDropDown<String>(
                              controller:
                                  _model.dropDownRunTerrainValueController ??=
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textFieldPrefDistanceTextController,
                                focusNode:
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Container(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.textFieldInstagramFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textFieldStravaTextController,
                                focusNode: _model.textFieldStravaFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(15.0, 35.0, 15.0, 25.0),
                    ...
                    await Future.wait([
                      ...
                      Future(() async {
                        ...
                        await currentUserReference!
                          ...
                          location: _model.textFieldLocationTextController.text,
