            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Invite your friends to join Novara',
                  ...
                  Builder(
                    builder: (context) => Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('INVITE_FRIENDS_COMP_Share_ON_TAP');
                          logFirebaseEvent('Share_share');
                          await Share.share(
                            'https://app.novara.social/app',
                ...
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'INVITE_FRIENDS_Container_0pdji4mg_ON_TAP');
                    logFirebaseEvent('Container_copy_to_clipboard');
                    await Clipboard.setData(
                        ClipboardData(text: 'https://app.novara.social/app'));
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'INVITE_FRIENDS_COMP_CANCEL_BTN_ON_TAP');
