...
import 'activity_details2_model.dart';
export 'activity_details2_model.dart';

class ActivityDetails2Widget extends StatefulWidget {
  const ActivityDetails2Widget({super.key});

  static String routeName = 'ActivityDetails2';
  static String routePath = '/activityDetails2';

  @override
  State<ActivityDetails2Widget> createState() => _ActivityDetails2WidgetState();
}

class _ActivityDetails2WidgetState extends State<ActivityDetails2Widget> {
  late ActivityDetails2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivityDetails2Model());
