...
class _CreateActivityWidgetState extends State<CreateActivityWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CreateActivity'});
    ...
    _model.textFieldPaceMask = MaskTextInputFormatter(mask: '##:##');
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_ACTIVITY_Container-Date_ON_TAP');
                                        logFirebaseEvent(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.textFieldDistanceFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
