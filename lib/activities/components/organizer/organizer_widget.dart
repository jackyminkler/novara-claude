...
class OrganizerWidget extends StatefulWidget {
  const OrganizerWidget({super.key});

  @override
  State<OrganizerWidget> createState() => _OrganizerWidgetState();
}

class _OrganizerWidgetState extends State<OrganizerWidget> {
  late OrganizerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizerModel());
