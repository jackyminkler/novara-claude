                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'ONBOARDING_PAGE_BackButton_ON_TAP');
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  ...
                                  height: 6.0,
                                  decoration: BoxDecoration(
                                    color: _model.pageViewGroupCurrentIndex == 0
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  height: 6.0,
                                  decoration: BoxDecoration(
                                    color: _model.pageViewGroupCurrentIndex == 1
                                        ? FlutterFlowTheme.of(context).primary
                                        : FlutterFlowTheme.of(context).accent2,
                                    borderRadius: BorderRadius.circular(6.0),
                                  ),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  height: 6.0,
                                  decoration: BoxDecoration(
                                    color: _model.pageViewGroupCurrentIndex == 2
                                        ? FlutterFlowTheme.of(context).primary
                                        : FlutterFlowTheme.of(context).accent2,
                                    borderRadius: BorderRadius.circular(6.0),
                                  ),
                                                  ...
                                                  builder: (context) {
                                                    ...
                                                    return Wrap(
                                                      ...
                                                      children: List.generate(
                                                          runTerrainList.length,
                                                          (runTerrainListIndex) {
                                                        final runTerrainListItem =
                                                            runTerrainList[
                                                                runTerrainListIndex];
                                                        return InkWell(
                                                          splashColor: Colors
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'ONBOARDING_Container_v7hgbdl9_ON_TAP');
                                                            if (FFAppState()
