                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  ...
                                  image: Image.asset(
                                    'assets/images/2KU6w8-a4C9JTkOsIQ61m.png',
                                  ).image,
                                ),
                              ),
                              child: Padding(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 15.0, 20.0, 0.0),
                                      child: Text(
                                        'Explore a list of local runs happening in your neighborhood or favorite parks, from trail runs to track workouts.',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/ChatGPT_Image_Jun_6,_2025,_11_04_12_AM.png',
                                  ).image,
                                ),
                              ),
                              child: Padding(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          25.0, 25.0, 25.0, 0.0),
                                      child: Text(
                                        'INVITE OTHERS TO JOIN YOUR RUNS',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .displayMedium
                                            .override(
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 15.0, 20.0, 0.0),
                                      child: Text(
                                        'Discover runners who share the same pace, distance, and availability preferences.\n\nCreate runs you love and enjoy them with runners nearby! ',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/03eRLXvI-2_D68yqK8I8W.png',
                                  ).image,
                                ),
                              ),
                              child: Padding(
