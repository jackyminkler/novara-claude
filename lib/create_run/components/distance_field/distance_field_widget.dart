...
import 'distance_field_model.dart';
export 'distance_field_model.dart';

class DistanceFieldWidget extends StatefulWidget {
  const DistanceFieldWidget({super.key});
...
class _DistanceFieldWidgetState extends State<DistanceFieldWidget> {
  late DistanceFieldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DistanceFieldModel());
